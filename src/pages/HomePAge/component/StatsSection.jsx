    ...
    <section className="bg-[#f7f4ee] py-12">
      <div className="container grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-slate-600">Better visibility on spending in just one month.</p>
        </div>
        <div className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-slate-600">Quick inputs, automatic summaries, no clutter.</p>
        </div>
      </div>
    </section>
  );
